...
import core.api_parser.parser_helper as helper
import core.api_parser.ValidationReport as vr
...
class ConfigValidator:
    ...
    def load_schema(self):
        ...
        try:
            self.schema = helper.load_json_file(self.schema_path) #contains now the data of schema
            return True
